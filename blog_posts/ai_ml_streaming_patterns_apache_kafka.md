...
![ML Pipeline](assets/ai_ml_patterns_01_ml_pipeline.png)
...
![Batch Training](assets/ai_ml_patterns_02_batch_training.png)
...
![Training Test Streams](assets/ai_ml_patterns_03_training_test_streams.png)
...
![Split Dataset Stream](assets/ai_ml_patterns_04_split_data_set_stream.png)
...
![K-Fold Streams](assets/ai_ml_patterns_05_k_fold_streams.png)
...
![Windowing Dataset Stream](assets/ai_ml_patterns_06_windowing_data_set_stream.png)
...
![Enrich Training Test Streams](assets/ai_ml_patterns_07_enrich_training_test_streams.png)
...
![Online Learning System](assets/ai_ml_patterns_08_online_learning_system.png)
...
![Retrieval Augmented Generation](assets/ai_ml_patterns_09_rag.png)
...
![Option 1 - Kafka Connect Source Connector for embeddings](assets/ai_ml_patterns_10_source_connector_embeddings.png)

The sink connector reads the embeddings from the topic and writes them into the vector database.

![Option 2 - Kafka Connect Sink Connector for embeddings](assets/ai_ml_patterns_11_sink_connector_embeddings.png)
...
![Historical Data Feed](assets/ai_ml_patterns_12_historical_data_feed.png)
...
![Summarization](assets/ai_ml_patterns_13_summarization.png)
...
![Structured Data Stream](assets/ai_ml_patterns_14_structured_data_stream.png)
...
![Data Generation](assets/ai_ml_patterns_15_data_generation.png)
...
![Tools Feed Stream](assets/ai_ml_patterns_17_tools_feed_stream.png)
